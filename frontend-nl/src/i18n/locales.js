export const translations = {
  'zh-TW': {
    ...
    pcbaIQC: {
      ...
      search: '搜尋',
      uid: 'UID',
      uidPlaceholder: 'UID 將顯示於此',
      searchingUid: '正在搜尋 UID...',
      uidReceived: 'UID 已接收',
      searchTimeout: 'UID 搜尋逾時',
      items: {
        wifi: 'WiFi',
        firmware: '韌體版本',
        touch: '觸控按鍵',
  ...
  en: {
    ...
    pcbaIQC: {
      ...
      search: 'Search',
      uid: 'UID',
      uidPlaceholder: 'UID will appear here',
      searchingUid: 'Searching for UID...',
      uidReceived: 'UID received',
      searchTimeout: 'UID search timeout',
      items: {
        wifi: 'WiFi',
